...
Modern web platform for digital engagement, education, and community.
...
- Place tests in `src/__tests__` or next to components
- Run tests with your preferred runner (e.g., Jest, Vitest)
...
- Use `index.ts` for exports in large folders

## Deployment

- Use GPT Engineer app or Netlify
